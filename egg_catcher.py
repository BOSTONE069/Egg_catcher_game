...
#This defines the creation of the eggs
def create_eggs():
    x = randrange(10,740)
    y = 40
...
#This defines the movement of the eggs
def move_eggs():
    for egg in eggs:
...
#This defines the behaviour of the eggs
def egg_dropped(egg):
    eggs.remove(egg)
    c.delete(egg)
    lose_a_life()
...
#This defines the behaviour of the lives score
def lose_a_life():
    global lives_remaning
    lives_remaning -= 1
    c.itemconfigure(lives_text, text='Lives : ' + str(lives_remaning))

#This defines the behaviour of the of the catcher and the eggs
def catch_check():
...
#This function help in determining the score and speed
...
# This fucnctions determines the movement of the catcher
def move_left(event):
...
#This bind the keys when pressed with the movenment of the catcher
